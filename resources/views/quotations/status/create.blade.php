...
@section('content')
    ...
    <div class="row">
        <div class="col s12 m6 mt-4">
            <h6>
                ...
                <a href="#" class="pointer"> / @lang('New Status') </a>
            </h6>
        </div>
    ...
    <div class="card hoverable">
        <div class="card-content">
            <span class="card-title"> @lang('Add Status') </span>
            ...
            <div class="row">
                <div class="col s12">
                    <div class="card">
                        <form method="post" action="{{ route('quotations_status.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-content">
                                <div class="row">
                                    <div class="col l12">
