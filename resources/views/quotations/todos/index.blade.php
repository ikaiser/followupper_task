    ...
    <div class="row">
        <div class="col s12 m6 mt-4">
            <h6>
                ...
                <a onclick="document.location.href='{{ route('quotations.to_do_list', $quotation->id) }}'" class="pointer">/&nbsp;@lang('Show todo')</a>
                <a href="#" class="pointer"> / @lang('Quotation') {{$quotation->name}} </a>
            </h6>
        </div>
