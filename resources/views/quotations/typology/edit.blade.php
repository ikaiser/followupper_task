...
@section('content')
    ...
    <div class="row">
        <div class="col s12 m6 mt-4">
            <h6>
                ...
                <a href="#" class="pointer"> / @lang('Edit Typology') </a>
            </h6>
        </div>
    ...
    <div class="card hoverable">
        <div class="card-content">
            <span class="card-title"> @lang('Edit Typology') </span>
            ...
            <div class="row">
                <div class="col s12">
                    <div class="card">
                        <form method="post" action="{{ route('quotations_typology.update', [$typology->id]) }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-content">
                                <div class="row">
                                    <div class="col l12">
                                        <div class="input-field my-3">
                                            ...
                                            <input type="text" name="typology" value="{{$typology->name}}">
                                        </div>
                                    </div>
                                </div>
