...
@section('content')
    ...
    <div class="card hoverable">
        <div class="card-content">
            <span class="card-title"> @lang('Edit activity') </span>

            @include("partials/flashdata")

            <form method="post" action="{{ route('activities.update', $activiy->id ) }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                  ...
                  <div class="col l12 s12">
                    <div class="input-field my-3">
                        ...
                        <input id="name" type="text" name="name" value="{{ old('name',$activiy->name) }}" autocomplete="no">
                    </div>
                  </div>
                  ...
                  <div class="col l12 s12">
                    <div class="input-field my-3">
                        ...
                        <textarea name="description" id="description" class="materialize-textarea">{{ old('description',$activiy->description) }}</textarea>
                    </div>
                  </div>
